...
def evaluate_model(model_weights_path, df_test_path):
    ...
    df_test = pl.read_parquet(df_test_path)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Evaluate NRMS model")
    ...
    # evaluate_model(args.model_weights_path, args.df_test_path)
    evaluate_model(model_path, df_test)